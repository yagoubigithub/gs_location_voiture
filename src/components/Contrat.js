...
import {removeFactureId , getLocation,removeLocation} from '../store/actions/locationAction';

import ContartPage from './ContratPage';
import Contrat2 from './Contrat2';
 class Contrat extends Component {
  ...
  componentWillReceiveProps(nextProps){
    ...
    if(nextProps.entreprise){
      this.setState({entreprise : {...nextProps.entreprise}})
    }
  ...
  const myPages = [];
  myPages.push(<ContartPage id={this.props.match.params.id}  client={{...this.state.location}} entreprise={this.state.entreprise}    /> ,<div style={{height :30} }></div>, <Contrat2 id={this.props.match.params.id}  client={{...this.state.location}} entreprise={this.state.entreprise}    />)
...
` );
 ...
 {this.state.location  && this.state.entreprise ? <span>

  <ContartPage id={this.props.match.params.id}  client={{...this.state.location}} entreprise={this.state.entreprise}    />
    

    <Contrat2 id={this.props.match.params.id}  client={{...this.state.location}} entreprise={this.state.entreprise}    />
...
export default  connect (mapStateToProps,mapActionToProps)(Contrat);
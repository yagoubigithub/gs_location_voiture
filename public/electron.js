...
*/
 ...
 // copy image.
                fs.copyFile(
                    value.image,
                  path.join(__dirname, "images", imageName + ".png").toString(),
                  err => {
                    if (err) throw err;
